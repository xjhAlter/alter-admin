    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const moving = function () {
                ...
                const { width, height, left, top } = (home.value as any).getBoundingClientRect()
                const halfWidth = width / 2
                const halfHeight = height / 2
                moveState.offsetX = (4.5 * (moveState.pageX - left - halfWidth)) / halfWidth
                moveState.offsetY = (4.5 * (moveState.pageY - top - halfHeight)) / halfHeight
            }
