    ...
    <div class="page">
        <div class="page-scroll-number">
            ...
            <div class="blog-container">
                ...
                <section class="blog-desc"> html代码如下(样式代码略)： </section>
...
&lt;&#47;div&gt;</code></pre>
  ...
  to {
    transform: translateY(calc(var(--i) * -9.09%));
                ...
                <section class="blog-desc">
                    动画2的效果如下,这里为了演示将animation-fill-mode设为infinite,
                    实际应用中要使用forwards
                ...
                <section class="blog-desc"> 将两段动画一起使用 </section>
                <div class="hljs-code" v-highlight>
  ...
  animation: move 0.3s linear infinite,
    bounce-in-down 1s 1s forwards; /* 1s 后执行第二段动画 */
                ...
                <section class="blog-desc"> 最终获得滚动数字的效果 </section>
            </div>
        </div>
    </div>
</template>
